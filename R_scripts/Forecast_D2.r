...
CognitiveClassModels <- TrainTadpoleClassModels(AdjustedTrainFrame,
                                                ...
                                                NumberofRepeats = 1)
save(CognitiveClassModels,file="data/temp/_CognitiveClassModels_25.RDATA.RDATA")
} else{
  load("data/temp/_CognitiveClassModels_25.RDATA.RDATA")
}
...
if (ignore == FALSE){
  ...
  save(CognitiveRegresModels,file="data/temp/_CognitiveRegresModels_50_Nolog.RDATA")
} else{
load("data/temp/_CognitiveRegresModels_50_Nolog.RDATA")
}
...
print("forecast_d2")
  ...
  write.csv(forecast,file="data/temp/_ForecastD2_BORREGOS_TEC.csv")
